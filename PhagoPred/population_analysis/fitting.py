...
def fit_logistic(t_data, N_data):
    ...
    # Initial guess: N0 is first count, r is small positive number
    p0 = [N_filtered[0], 0.2, 300]

    popt, pcov = scipy.optimize.curve_fit(logistic_model, t_filtered, N_filtered, p0=p0, sigma=sigma, absolute_sigma=True, bounds=([0, 0, 0], [np.inf, np.inf, 500]))
