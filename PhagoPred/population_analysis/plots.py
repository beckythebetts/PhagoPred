...
def plot_num_alive_cells(files: list = [SETTINGS.DATASET], save_as: Optional[Path]=None, first_frame: Optional[int] = None, last_frame: Union[int, list] = None, time_step: int = 5, labels: list = []) -> 'matplotlib.figure.Figure':
...
def main():
    ...
    #         [5, 5, 5],
    #         num_frames = 600)
    plot_num_alive_cells(files, Path('temp') / 'dead_cells.png', labels=labels, last_frame=[700, 450, 900])
